...
(function(){
    ...
    function renderWidget(target, options = {}) {
        ...
        if (elevenlabsContainer) {
            ...
            el.setAttribute('dynamic-variables', JSON.stringify({ pagina, nombre, modalidad, autoStart }));
        ...
        toggleBtn.onclick = async function() {
            if (isActive) {
                ...
                conversation = await window.Conversation.startSession({
                    signedUrl,
                    dynamicVariables: { pagina, nombre, modalidad, autoStart }, // <-- pasa pagina, nombre y modalidad a ElevenLabs
                    onConnect: () => {
                        updateStatus(true);
