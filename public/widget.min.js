...
(function(){
    ...
    function renderWidget(target, options = {}) {
        ...
        if (elevenlabsContainer) {
            ...
            el.setAttribute('dynamic-variables', JSON.stringify({ pagina, nombre, autoStart }));
        ...
        toggleBtn.onclick = async function() {
            if (isActive) {
                ...
                conversation = await window.Conversation.startSession({
                    signedUrl,
                    dynamicVariables: { pagina, nombre, autoStart }, // <-- pasa pagina, nombre y autoStart a ElevenLabs
                    onConnect: () => {
                        updateStatus(true);
